# Generated by Django 4.1.1 on 2023-02-15 11:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Chat',
            fields=[
                ('id', models.AutoField(db_column='message_id', primary_key=True, serialize=False)),
                ('chat_id', models.IntegerField()),
                ('user_name', models.CharField(max_length=50)),
                ('content', models.TextField(blank=True, null=True)),
                ('datetime_send', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
                ('sender', models.IntegerField(blank=True, db_column='sender_id', null=True)),
            ],
            options={
                'db_table': 'chat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialist', models.ForeignKey(blank=True, db_column='specialist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='spec', to='applications.authuser')),
                ('uid_division', models.ForeignKey(blank=True, db_column='uid_Division', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='applications.division')),
            ],
            options={
                'verbose_name': 'Заявка',
